...
## ৪. স্মার্ট ফিচারগুলো
- **প্রোডাক্ট জুম:** প্রোডাক্ট পেজে ছবির উপর মাউস রাখলেই সেই জায়গাটা ম্যাগনিফাইড হয়ে দেখা যায় (`js/product.js` এর `setupMagnifier` ফাংশন)।
- **কার্ট:** ব্রাউজারের localStorage-এ সেভ থাকে, পেজ রিলোড করলেও থাকে।
- **লগইন/সাইন আপ/পাসওয়ার্ড রিসেট:** পুরোপুরি Firebase Authentication দিয়ে করা।
